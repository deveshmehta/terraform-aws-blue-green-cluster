...
module "blue_cluster_asg" {
  ...
  clb_load_balancer_arns = [
    "${element(concat(module.blue_cluster_internal_clb.clb_load_balancer_arns, list("")), 0)}",
    "${element(concat(module.blue_cluster_external_clb.clb_load_balancer_arns, list("")), 0)}",
  ]
